 ...
 * @author henry
 */
public class notNumeric extends javax.swing.JFrame {

    /**
     * Creates new form notNumeric
     */
    public notNumeric() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(209, 30, 0));
        ...
        lblUN1.setText("Input is Not Numeric!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(notNumeric.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new notNumeric().setVisible(true);
            }
        });
    }
