 ...
 * @author henry
 */
public class InvalidPasswordMatch extends javax.swing.JFrame {

    /**
     * Creates new form noMatchPass
     */
    public InvalidPasswordMatch() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblUN1.setText("Passwords No Not Match!");
    ...
    /**
     * void method to return to previous
     * page
     * @param evt 
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvalidPasswordMatch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InvalidPasswordMatch().setVisible(true);
            }
        });
    }
