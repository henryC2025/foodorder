 ...
 * @author henry
 */
public class EmptyDetails extends javax.swing.JFrame {

    /** Creates new form EmptyDetails */
    public EmptyDetails() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmptyDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmptyDetails().setVisible(true);
            }
        });
    }
