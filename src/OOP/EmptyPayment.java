 ...
 * @author henry
 */
public class EmptyPayment extends javax.swing.JFrame {

    /**
     * Creates new form EmptyPayment
     */
    public EmptyPayment() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblUN1.setText("Payment is Not Selected!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmptyPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmptyPayment().setVisible(true);
            }
        });
    }
